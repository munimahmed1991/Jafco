...
Public Class frmAreaFile
    ...
    Sub FillCombo()
        Dim Name As New BindCombo(cmbName, "Select Name From tblAreaFile", "Name", "Name", True, True)
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        If CheckAccess("DeleteRights", UserId, "AREA FILE") = -1 Then
            If MsgBox("Do You Want to Delete this Record", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                Dim DB As New dbOperations("Delete From tblAreaFile Where Code = '" & txtCode.Text & "'")
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        If CheckAccess("EditRights", UserId, "AREA FILE") = -1 Then
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        If CheckAccess("AddRights", UserId, "AREA FILE") = -1 Then
            Call DisplayRec()
        Else
            MsgBox("Sorry You Dont Have Any Rights to Use This Option", vbInformation, cCompany)
            Exit Sub
    ...
    Sub DisplayRec()
        If txtCode.Text <> "" Then
            Dim DB As New dbOperations("Select * From tblAreaFile Where Code = '" & txtCode.Text & "'")
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If cmbCity.SelectedValue = "" Then
            MsgBox("Please Select City for the Defined Area")
            Exit Sub
        End If

        If txtCode.Text = "" Then
            txtCode.Text = NextSerial("Code", "tblAreaFile", "0000", "", "")
        ...
        If CheckDuplicate("tblAreaFile", "Name", cmbName.Text, txtCode.Text, "Code") = True Then
        ...
        Query.Refresh()
        Query.SetQueryInformation("tblAreaFile", "Code = '" & txtCode.Text & "'")
    ...
    Private Sub cmdSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSearch.Click
        txtCode.Text = ShowList("Select tblAreaFile.Code,tblAreaFile.Name,tblCity.Name as City From tblAreaFile,tblCity Where tblAreaFile.City = tblCity.Code Order By tblAreaFile.Code", "List of Country", 1, 0)
