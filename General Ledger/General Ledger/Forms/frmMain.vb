...
Public Class frmMain
    ...
    Private Sub ProductMasterFileToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ProductMasterFileToolStripMenuItem.Click
        If CheckAccess("AccessRight", UserId, "PRODUCT MASTER FILE") = -1 Then
    ...
    Private Sub PurchaseRequisitionToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PurchaseRequisitionToolStripMenuItem.Click
        If CheckAccess("AccessRight", UserId, "PURCHASE REQ PRODUCT") = -1 Then
            frmPurRequisitionProduct.MdiParent = Me
            frmPurRequisitionProduct.Show()
        Else
            MsgBox("Sorry You Dont Have Any Rights to Use This Option", vbInformation, cCompany)
            Exit Sub
        End If
    ...
    Private Sub PurchaseOrderToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PurchaseOrderToolStripMenuItem.Click
        If CheckAccess("AccessRight", UserId, "PURCHASE ORDER PRODUCT") = -1 Then
            frmPurOrderProduct.MdiParent = Me
            frmPurOrderProduct.Show()
        Else
            MsgBox("Sorry You Dont Have Any Rights to Use This Option", vbInformation, cCompany)
            Exit Sub
        End If
    ...
    Private Sub GoodsReceivedNoteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GoodsReceivedNoteToolStripMenuItem.Click
        If CheckAccess("AccessRight", UserId, "GRN PRODUCT") = -1 Then
            frmGRNProduct.MdiParent = Me
            frmGRNProduct.Show()
        Else
            MsgBox("Sorry You Dont Have Any Rights to Use This Option", vbInformation, cCompany)
            Exit Sub
    ...
    Private Sub LocalBillAccessoriesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LocalBillAccessoriesToolStripMenuItem.Click
        If CheckAccess("AccessRight", UserId, "PURCHASE BILL PRODUCT") = -1 Then
            frmPurchaseBillProduct.MdiParent = Me
            frmPurchaseBillProduct.Show()
        Else
            MsgBox("Sorry You Dont Have Any Rights to Use This Option", vbInformation, cCompany)
            Exit Sub
        End If
    ...
    Private Sub IssueAccessoriesGeneralToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles IssueAccessoriesGeneralToolStripMenuItem.Click
        If CheckAccess("AccessRight", UserId, "ISSUE PRODUCT") = -1 Then
            frmIssueProduct.MdiParent = Me
            frmIssueProduct.Show()
        Else
            MsgBox("Sorry You Dont Have Any Rights to Use This Option", vbInformation, cCompany)
            Exit Sub
        End If
    ...
    Private Sub LocationFileToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LocationFileToolStripMenuItem.Click
        If CheckAccess("AccessRight", UserId, "LOCATION FILE") = -1 Then
    ...
    Private Sub DepartmentFileToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DepartmentFileToolStripMenuItem.Click
        If CheckAccess("AccessRight", UserId, "DEPARTMENT FILE") = -1 Then
            frmDepartmentFile.MdiParent = Me
            frmDepartmentFile.Show()
        Else
            MsgBox("Sorry You Dont Have Any Rights to Use This Option", vbInformation, cCompany)
            Exit Sub
        End If
    ...
    Private Sub PaymentTermsFileToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PaymentTermsFileToolStripMenuItem.Click
        If CheckAccess("AccessRight", UserId, "PAYMENT TERMS FILE") = -1 Then
            frmPaymentTerms.MdiParent = Me
            frmPaymentTerms.Show()
        Else
            MsgBox("Sorry You Dont Have Any Rights to Use This Option", vbInformation, cCompany)
            Exit Sub
        End If
    ...
    Private Sub PackingTypeFileToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PackingTypeFileToolStripMenuItem.Click
        If CheckAccess("AccessRight", UserId, "PACKING TYPE FILE") = -1 Then
            frmPackingType.MdiParent = Me
            frmPackingType.Show()
        Else
            MsgBox("Sorry You Dont Have Any Rights to Use This Option", vbInformation, cCompany)
            Exit Sub
    ...
    Private Sub TransactionTypeFileToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TransactionTypeFileToolStripMenuItem.Click
        If CheckAccess("AccessRight", UserId, "PACKING TYPE FILE") = -1 Then
            frmTransactionType.MdiParent = Me
            frmTransactionType.Show()
        Else
            MsgBox("Sorry You Dont Have Any Rights to Use This Option", vbInformation, cCompany)
            Exit Sub
        End If
    ...
    Private Sub LevelFileToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LevelFileToolStripMenuItem.Click
        If CheckAccess("AccessRight", UserId, "LEVEL FILE") = -1 Then
            frmLevel.MdiParent = Me
            frmLevel.Show()
        Else
            MsgBox("Sorry You Dont Have Any Rights to Use This Option", vbInformation, cCompany)
            Exit Sub
    ...
    Private Sub PurchaseOrderGRNReportToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PurchaseOrderGRNReportToolStripMenuItem.Click

    End Sub

    Private Sub CustomerLedgerToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CustomerLedgerToolStripMenuItem.Click
        If CheckAccess("AccessRight", UserId, "CUSTOMER LEDGER") = -1 Then
            frmCustomerLedger.MdiParent = Me
