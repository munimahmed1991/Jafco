...
Public Class frmCustomerLedger
    ...
    Sub FillCombo()
        ...
        Dim Customer As New BindCombo(cmbCustomer, "Select Code,Name From tblCustomer Group by Code,Name", "Name", "Code", True, True)
    End Sub
    Private Sub cmdOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOk.Click
        Dim dr As SqlDataReader = Nothing
        Call ProgressBar(10)
        Dim fPreview As New frmPreview
        Dim rReport As New rptCustomerLedger


        Call ProgressBar(25)


        If cmbStatus.Text = "General Ledger" Then

            cSql = "Exec [CustomerLedger] '" & Format(txtDateFrom.Value, "MM/dd/yyyy") & "','" & Format(txtDateTo.Value, "MM/dd/yyyy") & "','" & cmbProject.SelectedValue & "','" & cmbCustomer.SelectedValue & "','" & cmbUnitType.SelectedValue & "','" & cmbUnit.SelectedValue & "','" & cmbStatus.Text & "','" & txtCC.Text & "'"
            ...
            rReport.fldTitle.Text = "CUSTOMER LEDGER FOR THE PERIOD FROM : " & Format(txtDateFrom.Value, "dd/MM/yyyy") & " TO : " & Format(txtDateTo.Value, "dd/MM/yyyy")
        ...
        Else
            ...
            Dim cTitleList As String = "CUSTOMER LEDGER FOR THE PERIOD FROM : " & Format(txtDateFrom.Value, "dd/MM/yyyy") & " TO : " & Format(txtDateTo.Value, "dd/MM/yyyy")
            ShowList(cSql, cTitleList, 0, 0, "TotalAmount,DueAmount,ReceiveAmount,Balance", "", "", "List", "ProjectName,CC,CustomerName", "", "", "", "No")
        End If

    End Sub

    Private Sub cmdUnitType_Click(sender As Object, e As EventArgs) Handles cmdUnitType.Click
    ...
    Private Sub cmdCustomer_Click(sender As Object, e As EventArgs) Handles cmdCustomer.Click
        cmbCustomer.SelectedValue = ShowList("Select * from tblCustomer", "List OF Customers", 1, 0)
    End Sub
    Private Sub cmbUnitTypeClear_Click(sender As Object, e As EventArgs) Handles cmbUnitTypeClear.Click
        cmbUnitType.SelectedValue = ""
    End Sub
    Private Sub cmbUnitNoClear_Click(sender As Object, e As EventArgs) Handles cmbUnitNoClear.Click
        cmbUnit.SelectedValue = ""
    End Sub
    Private Sub cmdCustomerClear_Click(sender As Object, e As EventArgs) Handles cmdCustomerClear.Click
