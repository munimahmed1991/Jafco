...
Public Class frmPaymentGroup
    ...
    Sub FillCombo()
        Dim Name As New BindCombo(cmbName, "Select Name From tblPaymentGroup", "Name", "Name", True, True)
    End Sub
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        If CheckAccess("DeleteRights", UserId, "RECEPTION MODULE") = -1 Then
            If MsgBox("Do You Want to Delete this Record", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                Dim DB As New dbOperations("Delete From tblPaymentGroup Where Code = '" & txtCode.Text & "'")
    ...
    Sub DisplayRec()
        If txtCode.Text <> "" Then
            Dim DB As New dbOperations("Select * From tblPaymentGroup Where Code = '" & txtCode.Text & "'")
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If txtCode.Text = "" Then
            txtCode.Text = NextSerial("Code", "tblPaymentGroup", "0000", "", "")
        ...
        If CheckDuplicate("tblPaymentGroup", "Name", cmbName.Text, txtCode.Text, "Code") = True Then
        ...
        Query.Refresh()
        Query.SetQueryInformation("tblPaymentGroup", "Code = '" & txtCode.Text & "'")
    ...
    Private Sub cmdSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSearch.Click
        txtCode.Text = ShowList("Select * From tblPaymentGroup Order By Code", "List of Country", 1, 0)
