...
Imports GrapeCity.ActiveReports.Viewer
Imports GrapeCity
...
Public Class frmPreview
    ...
    Private Sub frmPreview_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.FormClosed
    ...
    Private Sub arv_HyperLink(ByVal sender As Object, ByVal e As GrapeCity.ActiveReports.Viewer.Win.HyperLinkEventArgs) Handles arv.HyperLink
    ...
    Private Sub frmPreview_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'Dim _btn As New GrapeCity.ActiveReports.Design.ToolPanelButton
        '_btn.ImageIndex = 14 ' new images were added to Toolbar.Images 
        '_btn.ButtonStyle = GrapeCity.ActiveReports.C.Toolbar.ButtonStyle.Text
        '_btn.Caption = "Save"
    ...
    'Private Sub arv_ToolClick(ByVal sender As Object, ByVal e As ActiveReports.Toolbar.ToolClickEventArgs) Handles arv.ToolClick
    '    Try
    ...
    Private Sub cmdExportPDFPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdExportPDFPrint.Click, Button2.Click, Button1.Click



        Dim pdf As New GrapeCity.ActiveReports.Export.Pdf.Section.PdfExport()
        pdf.Export(Me.arv.Document, "e:\myActiveReport.pdf")
        ...
        'psiPrint.FileName = "e:\myActiveReport.pdf"
