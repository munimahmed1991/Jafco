...
Public Class frmPaymentTerms
    ...
    Sub FillCombo()
        Dim Name As New BindCombo(cmbName, "Select Name From tblPaymentTerms", "Name", "Name", True, True)
    End Sub
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        If CheckAccess("DeleteRights", UserId, "PAYMENT TERMS FILE") = -1 Then
            If MsgBox("Do You Want to Delete this Record", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                Dim DB As New dbOperations("Delete From tblPaymentTerms Where Code = '" & txtCode.Text & "'")
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        If CheckAccess("EditRights", UserId, "PAYMENT TERMS FILE") = -1 Then
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        If CheckAccess("AddRights", UserId, "PAYMENT TERMS FILE") = -1 Then
            Call DisplayRec()
        Else
            MsgBox("Sorry You Dont Have Any Rights to Use This Option", vbInformation, cCompany)
            Exit Sub
    ...
    Sub DisplayRec()
        If txtCode.Text <> "" Then
            Dim DB As New dbOperations("Select * From tblPaymentTerms Where Code = '" & txtCode.Text & "'")
            ...
            Else
                MsgBox("Payment Terms Code Does Not Exist")
                Exit Sub
            End If
        Else
            Call SetControls(Actions.Entry)
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If txtCode.Text = "" Then
            txtCode.Text = NextSerial("Code", "tblPaymentTerms", "0000", "", "")
        ...
        If CheckDuplicate("tblPaymentTerms", "Name", cmbName.Text, txtCode.Text, "Code") = True Then
        ...
        Query.Refresh()
        Query.SetQueryInformation("tblPaymentTerms", "Code = '" & txtCode.Text & "'")
    ...
    Private Sub cmdSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSearch.Click
        txtCode.Text = ShowList("Select * From tblPaymentTerms Order By Code", "List of Currency", 1, 0)
