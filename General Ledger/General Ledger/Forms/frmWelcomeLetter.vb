...
Public Class frmWelcomeLetter
    ...
    Private Sub cmdGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGenerate.Click
        cSql = "Select	0 as Generate,'" & Format(txtGenerateDate.Value, "MM/dd/yyyy") & "' as GenerateDate,'Welcome Letter' as LetterType,"
        ...
        cSql += "And	tblReservationMst.Unit Not In (Select Unit From tblLetters Where LetterType = 'Welcome Letter') "
        cSql += "And    tblReservationMst.ReservationDate <= '" & Format(txtGenerateDate.Value, "MM/dd/yyyy") & "' "
        cSql += "And    tblReservationMst.Unit In (Select Unit From tblReceiptMst,tblReceiptDtl Where tblReceiptMst.ReceiptNo = tblReceiptDtl.ReceiptNo and PaymentType = '0001')"
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        For Each row As DataRow In dbGrid.cDataTableCollection(0).Select
            If RemoveNull(row!Generate, 0) = 1 Then
                cNextNo = NextSerial("EntryNo", "tblLetters", "000", cPrefix + "/" + Trim(row!UnitNumber) + "/")

                cSql = "Insert Into tblLetters(EntryNo,EntryDate,LetterType,Customer,Customer2,Unit,Project,GenerateSystemDate) Values('" & cNextNo & "','" & Format(Today.Date, "MM/dd/yyyy") & "','Welcome Letter','" & row!Customer & "','" & row!Customer2 & "','" & row!Unit & "','" & row!Project & "','" & Format(Today.Date, "MM/dd/yyyy") & "')"
