...
Public Class frmUnitFile
    ...
    Sub DisplayRec()
        If txtCode.Text <> "" Then
            ...
            If DR.HasRows Then
                ...
                txtFloors.Text = RemoveNull(DR!Floors, "")
                txtSqFeet.Value = RemoveNull(DR!SqFeet, 0)
                cmbCategory.Text = RemoveNull(DR!Category, "")
                ...
                txtArea.Text = RemoveNull(DR!Area, "")
                ...
                txtCancelReason.Text = RemoveNull(DR!CancelReason, "")
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If cmbCategory.Text = "" Then
            MsgBox("Category Cannot be Left Blank")
            cmbCategory.Focus()
            Exit Sub
        End If
        ...
        If chkCancel.Checked = False Then
            If cAdd = True Then
                db = New dbOperations("Select * from tblUnitFile where UnitNumber = '" & cmbUnitNumber.Text & "' and Project = '" & cmbProject.SelectedValue & "' and UnitType = '" & cmbUnitType.SelectedValue & "' and Block = '" & cmbBlock.SelectedValue & "' and IsNull(Cancel,0) = 0 ")
                dr = db.dbSelectQuery()
        ...
        Query.AddFields("Floors", txtFloors.Text, ActionQueryBuilder.DataType.aString)
        Query.AddFields("SqFeet", txtSqFeet.Value, ActionQueryBuilder.DataType.aInteger)
        ...
        Query.AddFields("Area", txtArea.Text, ActionQueryBuilder.DataType.aString)
        ...
        If chkCancel.Checked = True Then
            ...
            Query.AddFields("CancelReason", txtCancelReason.Text, ActionQueryBuilder.DataType.aString)
        End If
        ...
        If chkCancel.Checked = True Then
            db = New dbOperations("Update tblReservationMst Set Cancel = 1,CancelDate = '" & Format(txtCancelDate.Value, "MM/dd/yyyy") & "',CancelCharges = '" & txtCancelCharges.Value & "',CancelReason='" & txtCancelReason.Text & "' Where Unit = '" & txtCode.Text & "'")
            db.dbActionQuery()
    ...
    Private Sub txtCode_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtCode.KeyPress, txtFloors.KeyPress, txtArea.KeyPress, txtCancelReason.KeyPress
    ...
    Private Sub cmdSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSearch.Click
        ...
        cSql = "Select tblUnitFile.Code,tblProjectFile.Name as Project,tblUnitFile.UnitNumber,tblUnitFile.Category,tblUnitFile.SqFeet,tblUnitFile.Floors,tblBlock.Name as Block,tblUnitType.Name as UnitType,1 as Unit,tblUnitFile.CashAmount,tblUnitFile.LoanAmount,tblUnitFile.TotalRevenue,tblUnitFile.Area, "
        ...
        txtCode.Text = ShowList(cSql, "List of Unit Type", 1, 0, "Unit,CashAmount,LoanAmount,TotalRevenue,ExtraCharges,GrossTotal,ExtraChargesAmount1,ExtraChargesAmount2,ExtraChargesAmount3")
