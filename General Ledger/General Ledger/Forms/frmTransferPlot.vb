...
Public Class frmTransferPlot
    ...
    Sub DisplayRec()
        If txtTransferNo.Text <> "" Then
            ...
            If dr.HasRows Then
                ...
                Call PickCC(cmbUnitFrom.SelectedValue)
    ...
    Private Sub PickCC(ByVal cUnit As String)
        db = New dbOperations("Select isnull(CC,'') as CC from tblReservationMst where unit = '" & cUnit & "'")
        dr = db.dbSelectQuery

        If dr.HasRows = True Then
            dr.Read()

            txtCC1.Text = RemoveNull(dr!CC, "")
        End If
