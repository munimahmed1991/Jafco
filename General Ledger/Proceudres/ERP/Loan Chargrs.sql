...
/****** Object:  StoredProcedure [dbo].[LoanCharges]    Script Date: 4/2/2016 4:32:21 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER Procedure [dbo].[LoanCharges] @DateFrom DateTime,@DateTo DateTime,@Project Varchar(4),@UnitType Varchar(10),@UnitNumber Varchar(14),@ReportType Varchar(50),@PaymentStatus Varchar(20),@Penalty Numeric(9) = 0 ,@PaymentType Varchar(4) = '',@CustomerType Varchar(50) = 'Both'
...
And		tblPaymentType.ReceivedAs = 'Loan'
Group BY tblInvoice.InvoiceNo

Select	tblUnitFile.UnitType,Mst.Project,Mst.Unit,tblUnitFile.UnitNumber,Max(IsNull(Mst.LoanAmount,0)) as TotalCharges,0 as DueTillDate,0 as AmountReceived
Into	#Temp1
...
Having Sum(#Temp5.TotalCharges) > 0 
...
And		Substring(tblLetters.LetterType,1,4) = 'HBFC'
Group By Unit
