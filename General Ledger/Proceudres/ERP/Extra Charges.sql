...
/****** Object:  StoredProcedure [dbo].[ExtraCharges]    Script Date: 4/2/2016 4:31:58 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER Procedure [dbo].[ExtraCharges] @DateFrom DateTime,@DateTo DateTime,@Project Varchar(4),@UnitType Varchar(10),@UnitNumber Varchar(14),@ReportType Varchar(50),@PaymentStatus Varchar(20),@Penalty Numeric(9) = 0 ,@PaymentType Varchar(4) = '',@CustomerType Varchar(50) = 'Both'
...
And		tblPaymentType.ReceivedAs = 'Extra Charges'
Group BY tblInvoice.InvoiceNo

Select	tblUnitFile.UnitType,Mst.Project,Mst.Unit,tblUnitFile.UnitNumber,Max(IsNull(Mst.ExtraCharges,0)) as TotalCharges,0 as DueTillDate,0 as AmountReceived
Into	#Temp1
