...
Public Class frmSupplier
    ...
    Private Sub cmdSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSearch.Click
        txtCode.Text = ShowList("Select tblSupplier.Code,tblSupplier.Name,Category,Address,tblOrigin.Name as Origin,tblCOuntry.Name as Country,tblCity.Name as City,Phone,Fax,Email,Website,StaxRegNo,NTNNo From tblSupplier,tblOrigin,tblCountry,tblCity Where tblSupplier.Origin = tblOrigin.Code and tblSupplier.Country = tblCountry.Code and tblSupplier.City = tblCity.Code Order By tblSupplier.Code", "List of Suppliers", 1, 0, "", "", "", "List", "", "", "No")
