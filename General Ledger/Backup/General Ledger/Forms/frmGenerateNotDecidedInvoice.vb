...
Public Class frmGenerateNotDecidedInvoice
    ...
    Private Sub cmdGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGenerate.Click
        ...
        If cmbPaymentType.SelectedValue = "" Then
            MsgBox("Select Payment - Cannot Proceed")
            Exit Sub
        End If
        ...
        cSql += "And   IsNull(NotDecided,0) = 1  "
        ...
        If cmbBlock.SelectedValue <> "" Then
            cSql += "And   tblResercationMst.Unit In (Select Code From tblUnitFile Where Block = '" & cmbBlock.SelectedValue & "' "
        End If
        ...
        If dr.HasRows Then
            ...
            cInvoiceNo = NextSerial("InvoiceNo", "tblInvoice", "00000000", "INV" + cPrefix + "-", "Project = '" & cmbProject.SelectedValue & "'")
            ...
            MsgBox("All Invoices Generated Successfully for " + cmbPaymentType.Text)
        End If
    End Sub

    Private Sub frmGenerateNotDecidedInvoice_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmdPaymentType_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPaymentType.Click
        ...
        cmbPaymentType.SelectedValue = ShowList("Select Code,Name from tblPaymentType Where Code In (Select PaymentType From tblReservationDtl,tblReservationMst Where tblReservationMst.ReservationNo = tblReservationDtl.ReservationNo and Project = '" & cmbProject.SelectedValue & "') Order By Name", "List of Payment Types", 1, 0)
    End Sub
