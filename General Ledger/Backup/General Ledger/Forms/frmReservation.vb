...
Public Class frmReservation
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If RemoveNull(txtCashAmount.Value, 0) + RemoveNull(txtExtraCharges.Value, 0) - RemoveNull(txtDiscount.Value, 0) > cTotalAmount Then
    ...
    Private Sub cmdSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSearch.Click
        ...
        If cFormType <> "Cancel" Then
            cSql = "Select ReservationNo,1 as Reservation,ReservationDate,tblProjectFile.Name as ProjectName,tblCustomer.Name as CustomerName,tblUnitType.Name as UnitType,tblUnitFile.UnitNumber as Unit,PaymentPlan,NoofMonths,tblReservationMst.CashAmount,tblReservationMst.LoanAmount,tblReservationMst.ExtraCharges,Discount,tblReservationMst.TotalRevenue,tblCustomer.Mobile,tblCustomer.TelRes,tblAgent.Name as AgentName,tblAgentCompany.Name as AgentCompany,RefundAmount,RefundPaid,tblCustomer.NICNo,AddOtherCharges "
        Else
            cSql = "Select ReservationNo,1 as Reservation,ReservationDate,tblReservationMst.CancelDate,tblProjectFile.Name as ProjectName,tblCustomer.Name as CustomerName,tblUnitType.Name as UnitType,tblUnitFile.UnitNumber as Unit,PaymentPlan,NoofMonths,tblReservationMst.CashAmount,tblReservationMst.LoanAmount,tblReservationMst.ExtraCharges,Discount,tblReservationMst.TotalRevenue,tblCustomer.Mobile,tblCustomer.TelRes,tblAgent.Name as AgentName,tblAgentCompany.Name as AgentCompany,RefundAmount,RefundPaid,tblCustomer.NICNo,AddOtherCharges "
        End If
