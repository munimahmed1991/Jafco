...
Public Class frmServiceDueLetter4
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        For Each row1 As DataRow In dbGrid.cDataTableCollection(0).Select
            If RemoveNull(row1!Generate, 0) = 1 Then
                ...
                cSql = "Insert Into tblLetters(EntryNo,EntryDate,LetterType,Customer,Customer2,Unit,Project,GenerateSystemDate,PreviousLetters) Values('" & cNextNo & "','" & row1!GenerateDate & "','Due Service Letter 4','" & row1!Customer & "','" & row1!Customer2 & "','" & row1!Unit & "','" & row1!Project & "','" & Format(Today.Date, "MM/dd/yyyy") & "','" & cPreviousLetter & "')"
