...
Public Class frmGeneratePenalty
    ...
    Private Sub cmdGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGenerate.Click
        ...
        If txtDueDate.Value = Nothing Then
            MsgBox("Input Due Date To - Cannot Proceed")
            Exit Sub
        End If

        If RemoveNull(txtInvoiceDate.Value, Nothing) = Nothing Then
        ...
        cSql = "Exec PenaltyGeneration '" & Format(txtDueDate.Value, "MM/dd/yyyy") & "','" & cmbProject.SelectedValue & "','" & cmbUnitType.SelectedValue & "','" & cmbUnit.SelectedValue & "'"
        ...
        If dr.HasRows Then
            ...
            cInvoiceNo = NextSerial("InvoiceNo", "tblInvoice", "00000000", "PEN" + cPrefix + "-", "Project = '" & cmbProject.SelectedValue & "' and IsNull(Penalty,0) = 1")

            cSql = "Insert Into tblInvoice(InvoiceNo,InvoiceDate,Project,Customer1,Customer2,UnitType,Unit,PaymentType,ExtraCharges,DueDate,Amount,Installment,NotDecided,Penalty) Values('" & cInvoiceNo & "','" & Format(txtInvoiceDate.Value, "MM/dd/yyyy") & "','" & dr!Project & "','" & dr!Customer & "','" & dr!Customer2 & "','" & dr!UnitType & "','" & dr!Unit & "','" & dr!PaymentType & "','','" & Format(txtInvoiceDate.Value, "MM/dd/yyyy") & "'," & dr!Penalty & ",1,0,1)"
            ...
            MsgBox("All Penalty Invoices Generated Successfully")
        End If
    End Sub
