...
Public Class frmList
    ...
    Private Sub SetupTheGrid()
        ...
        For Each dc As C1DisplayColumn In grdList.Splits(0).DisplayColumns
            ...
            If dc.DataColumn.DataType.Name = "Decimal" Then
                dc.DataColumn.NumberFormat = "###,###,##0"
            End If
    ...
    Private Sub ToolStripButton4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton4.Click
        Call ExportExcel(cQueryString)

        ''Me.grdList.ExportToExcel("c:\Excel.xls")

        ''MsgBox("Data Exported to Excel Please Open File C:\Excel.xls")
